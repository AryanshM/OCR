...
def ocr(image,results,रीडर ):
    ...
    for c in cnts:
        ...
        if h <150 and h>50 and x>150 and x<1450 and y>150 and y<800:
            ...
            ocr_result = reader.readtext(roi, detail=0, paragraph=True, allowlist = combined_allowlist)
...
ocr(image,results,reader)


cv2.imwrite("PAN/panB_BOX.jpg", image)
print(results)
